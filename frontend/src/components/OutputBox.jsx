...
function OutputBox({ label, value, minHeight = 32 }) {
  return (
    <div className="output-box"style={{ marginBottom: 12 }}>
      {label && <div className="output-box-label" style={{ fontWeight: 500, marginBottom: 4 }}>{label}</div>}
      <div style={{
        position: 'relative',
        flex: 1,
        wordBreak: 'break-all',
